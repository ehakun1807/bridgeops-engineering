        ...
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <button
              ...
              aria-label="Get your free Ramp Readiness Score"
            ...
            >
              <Hammer size={18} className="mr-3 group-hover:rotate-12 transition-transform" />
              Get Your Free Ramp Score
              <ArrowRight className="ml-3 group-hover:translate-x-1 transition-transform" size={18} />
            </button>
            <button
              onClick={() => onNavigate?.('services')}
              aria-label="Browse our engineering services"
              className="w-full sm:w-auto flex items-center justify-center space-x-3 px-6 py-4 bg-white/5 border border-white/10 rounded-sm hover:bg-white/10 transition-all text-left"
            >
