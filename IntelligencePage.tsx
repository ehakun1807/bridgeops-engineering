        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              <div className="w-24 h-24 rounded-full flex items-center justify-center shadow-2xl shadow-blue-600/40" style={{background: 'radial-gradient(circle at 38% 35%, #60A5FA, #1D4ED8 70%)'}}>
                <svg width="68" height="68" viewBox="0 0 68 68" fill="none">
                  ...
                  {/* BridgeOps logo mark — scaled to fit upper portion */}
                  <g clipPath="url(#bridgetCircle)" transform="translate(6, 4) scale(0.228)" opacity="0.95">
                  ...
                  {/* Gentle eyes */}
                  <ellipse cx="27" cy="46" rx="2.2" ry="2.4" fill="white" opacity="0.9"/>
                  <ellipse cx="41" cy="46" rx="2.2" ry="2.4" fill="white" opacity="0.9"/>
                  <circle cx="27.6" cy="46.5" r="1" fill="rgba(30,58,138,0.8)"/>
                  <circle cx="41.6" cy="46.5" r="1" fill="rgba(30,58,138,0.8)"/>
                  {/* Smile */}
                  <path d="M25 53 Q34 58.5 43 53" stroke="white" strokeWidth="1.6" strokeLinecap="round" fill="none" opacity="0.85"/>
                </svg>
              </div>
