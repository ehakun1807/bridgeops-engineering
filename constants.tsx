...
// Kept as a named alias of ServiceItem so existing imports (ServiceCard, etc.)
// stay intact even though there are no longer any extra fields.
export type DetailedServiceItem = ServiceItem;
