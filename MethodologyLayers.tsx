...
interface MethodologyLayersProps {
  onNavigate?: NavigateFn;
}

const MethodologyLayers: React.FC<MethodologyLayersProps> = ({ onNavigate }) => {
  const layers = [
    {
      id: 1,
      title: 'ASSESS',
    ...
    <div className="bg-white">
      <section className="bg-slate-950 py-24 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <p className="text-slate-400 text-lg font-medium max-w-2xl mx-auto leading-relaxed mb-8">
          ...
          <button
            ...
            aria-label="See how the four stages map to engagements"
            className="inline-flex items-center gap-3 text-blue-400 hover:text-blue-300 font-black uppercase tracking-[0.25em] text-[10px] border-b border-blue-400/40 hover:border-blue-300 pb-1 transition-colors"
          >
            Three Engagement Tiers Cover the Four Stages
            <ArrowRight size={12} />
          </button>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-slate-100 pt-20">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-black text-slate-900 mb-2 uppercase">High-Yield Lines</h4>
              <p className="text-slate-500 font-medium uppercase tracking-widest text-[9px]">Stable production line yield</p>
            </div>
          </div>
          ...
          <div className="mt-32 text-center">
            <div className="inline-block p-12 bg-slate-900 rounded-none border border-slate-800 shadow-2xl relative overflow-hidden group">
              <div className="absolute inset-0 blueprint-grid-dark opacity-10"></div>
              <h3 className="text-2xl font-black text-white relative z-10 mb-4 tracking-tighter uppercase">Turn the Method into Work</h3>
              <p className="text-slate-400 mb-8 relative z-10 font-medium text-sm">Run the free snapshot, or see how the four stages map to a working engagement.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                ...
                >
                  Run Free Snapshot <ArrowRight className="ml-3" size={16} />
                </button>
                <button
                  onClick={() => onNavigate?.('pricing')}
                  aria-label="See how the methodology maps to engagements"
                ...
                >
                  See How We Work <ArrowRight className="ml-3" size={16} />
                </button>
              </div>
            </div>
          </div>
